            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="left-images">
                        ...
                        <img src="{{ asset('storage/' . $backpack->image) }}" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <input type="hidden" id="userId" value="{{ Auth::user()->id }}">
                    <input type="hidden" id="productId" value="{{ $backpack->id }}">
                    <div class="right-content">
                        <h4>{{ $backpack->name }}</h4>
                        <span class="price">{{ $backpack->price }}</span>
                        <ul class="stars">
                            ...
                            <div class="right-content">
                                <div class="quantity buttons_added">
                                    <input type="button" value="-" class="minus"><input type="number" step="1"
                                        min="1" max="" name="quantity" value="1" id="orderCount"
