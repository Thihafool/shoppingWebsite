        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contact" action="{{route('user#contacting')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <fieldset>
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <textarea class="@error('message') is-invalid @enderror" name="message" rows="6" id="message" placeholder="Your message" ></textarea>
                                    @error('message')
                            ...
                            <div class="col-lg-12 ">
                                <fieldset>
                                    <button type="submit" id="form-submit" class="main-dark-button mt-2"><i
