                ...
                <div class="col-lg-12">
                    <div class="men-item-carousel">
                        <div class="owl-men-item owl-carousel">
                            @foreach ($menProduct as $m)
                                <div class="item">

                                    <div class="thumb">
                                        <div class="hover-content">
                                            <ul>
                                                <li><a href="{{ route('detail#men', $m->id) }}"><i
                                                            class="fa fa-eye"></i></a>
                                                </li>
                                                <li><a href="{{ route('detail#men', $m->id) }}"><i
                ...
                <div class="col-lg-12">
                    <div class="women-item-carousel">
                        <div class="owl-women-item owl-carousel">
                            @foreach ($womenProduct as $w)
                                <div class="item">

                                    <div class="thumb">
                                        <div class="hover-content">
                                            <ul>
                                                <li><a href="{{ route('detail#women', $w->id) }}"><i
                                                            class="fa fa-eye"></i></a>
                                                </li>
                                                <li><a href="{{ route('detail#women', $w->id) }}"><i
                                                            class="fa fa-shopping-cart"></i></a>
                ...
                <div class="col-lg-12">
                    <div class="kid-item-carousel">
                        <div class="owl-kid-item owl-carousel">
                            @foreach ($kidProduct as $k)
                                <div class="item">

                                    <div class="thumb">
                                        <div class="hover-content">
                                            <ul>
                                                <li><a href="{{ route('detail#kid', $k->id) }}"><i
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form id="subscribe" action="{{route('user#subscribe')}}" method="Post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-5">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-6">
                            <ul>
                                <li>
                                    Store Location:<br /><span>Sunny Isles Beach, FL 33160, United States</span>
                                </li>
                        ...
                        <div class="col-6">
                            <ul>
                                ...
                                <li>
                                    Social Media:<br /><span><a href="#">Facebook</a>, <a
                                            href="#">Instagram</a>,
