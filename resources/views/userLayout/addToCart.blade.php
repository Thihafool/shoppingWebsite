...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li class="scroll-to-section"><a href="{{ route('user#womenCollection') }}">Women's</a></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        <div class="logo">
                            <img src="{{ asset('user/images/white-logo.png') }}" alt="hexashop ecommerce templatemo" />
                        </div>
                        <ul>
    ...
    <script src="{{ asset('user/js/quantity.js') }}"></script>
